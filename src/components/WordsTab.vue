<template>
  <div :data-lang="optionsData.pluginLanguage">
    <div class="d-flex justify-end px-2" style="margin-bottom: 0.5rem; gap: 0.5rem;"> <!-- Added gap -->
    ...
    <v-row>
      <v-col cols="12">
        <v-text-field append-icon="mdi-magnify" autofocus density="compact" v-model="search" clearable
          :label="util.getText('Search')"></v-text-field>
      </v-col>
    </v-row>

    <v-pagination v-model="page" :length="totalPages" density="compact" class="mb-2" />
