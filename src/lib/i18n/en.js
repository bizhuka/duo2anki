export default {
    ...
    "constructorFront": "Constructor (Front)",
    "constructorBack": "Constructor (Back)",
    "openInNewTab": "Open in new tab",
    "gameNotifications": "Game Notifications",
    "timeUnit_min": "{0} min",
    "timeUnit_hour": "{0} hour",
    "timeUnit_hours": "{0} hours",
    "timeUnit_day": "{0} day",
    "timeUnit_days": "{0} days",
    "timeUnit_week": "{0} week",
    "includeScheduleInformation": "Include schedule information",
    "mainTemplate": "Main template",
    "errorExportingToAnki": "Error exporting to Anki. See console for details.",
    "hintOrTranscription": "Hint or transcription",
    "checkAnswer": "Check Answer",
    "nextSentence": "Next Sentence",
    "startAgain": "Start Again",
    "reviewSessionFinished": "Review session finished!",
